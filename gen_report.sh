...
TAIGA_URL=`cat input/config.json  |jq .REPORT.TAIGA_API_URL | cut -d '"' -f2`
PROJECT_SLUG=`cat input/config.json  |jq .REPORT.TAIGA_SLUG | cut -d '"' -f2`
